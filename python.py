...
# Create a function iterateDictionary(some_list) that, given a list of dictionaries, the function loops through each dictionary in the list and prints each key and the value
students = [
    {'first_name':  'Michael', 'last_name': 'Jordan'},
    {'first_name': 'John', 'last_name': 'Rosales'},
...
def printInfo(some_dict):
    for i in some_dict:
        ...
        for val in range(len(some_dict[i])):
            print(some_dict[i][val])
